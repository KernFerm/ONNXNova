...
Current documented release: `0.0.50`

## ✨ What ONNX Nova Does

- Converts trusted `.pt` model files into `.onnx`
- Supports modern Ultralytics models and legacy YOLOv5 compatibility paths
...
- The model may need the legacy YOLOv5 compatibility path instead of the newer Ultralytics loader
