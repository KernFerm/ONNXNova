...
- refreshed release documentation for `0.0.100`
- kept the packaged dependency security updates documented for the current release
...
- refreshed release documentation for `0.0.80`
...
- refreshed release documentation for `0.0.71`
...
- improved packaged release support and installer flow updates
